    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full bg-card border border-white/10 rounded-2xl p-8 shadow-2xl">
        <div className="text-center mb-8">
           ...
           <p className="text-gray-400 mt-2">Tham gia cộng đồng Promptfree ngay hôm nay</p>
        </div>
        ...
        <div className="mt-6 text-center text-sm text-gray-400">
            Đã có tài khoản? <Link to="/login" className="text-primary hover:text-white">Đăng nhập</Link>
        </div>
      </div>
    </div>
  );
